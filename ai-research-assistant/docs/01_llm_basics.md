...
When we talk to an LLM like Google Gemini, we typically use two types of messages:
...
### Phase 1 Goal
We will build a simple script that sends a message to Gemini and prints the response. This helps us ensure our API key and network connection are working.
